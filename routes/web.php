...
Route::get('/artikel/{id}', 'ArticleController@show'); // menampilkan detail artikel dengan id
Route::get('/artikel/{id}/edit', 'ArticleController@edit'); // menampilkan form untuk edit artikel
